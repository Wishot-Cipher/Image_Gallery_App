...
import ReactSpinner from "../ImageGallery/ReactSpinner"; // Import the spinner component

Modal.setAppElement("#root"); // Assuming your root element has the id 'root'

export const Photo = forwardRef(({ url, index, faded, style, tags, ...props }, ref) => {
  ...
  return (
    <>
      ...
      <button
        onClick={openModal}
        className="mb-6 text-white bg-indigo-950 px-4 py-3 rounded-lg md:hidden w-full font-bold -mt-2"
      >
        View
      </button>
      ...
      >
        <div className="modal-content">
          {loading ? ( // Show spinner in modal too
            <div className="flex justify-center items-center h-full">
              <ReactSpinner />
            </div>
          ) : (
